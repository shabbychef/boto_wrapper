...
#
# SVN: $Id: create_vault.py 43293 2014-08-18 17:40:22Z svnsync $
# Created: 2014.06.05
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="create a new vault.")
    ...
    the_vault = layer2.create_vault(args.vault_name)
